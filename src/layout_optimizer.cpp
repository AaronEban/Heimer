        ...
        while (t > 0.05) {
            ...
            do {
                ...
                for (size_t i = 0; i < m_layout->all.size() * 200; i++) {
                    ...
                    LayoutOptimizer::Impl::Cell::globalIteration++;
...
private:
    ...
    private:
        ...
        {
            if (m_iteration == Cell::globalIteration) {
                return 0;
            }

            m_iteration = Cell::globalIteration;
...
size_t LayoutOptimizer::Impl::Cell::globalIteration = 0;
